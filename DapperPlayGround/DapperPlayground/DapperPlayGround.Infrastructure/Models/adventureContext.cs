...
namespace DapperPlayGround.Infrastructure.Models
{
    public partial class AdventureContext : DbContext
    {
        ...
        public virtual DbSet<VMProductDetail> VMProductDetails { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=adventure");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VMProductDetail>(entity =>
            {
                ...
                entity.ToView("vM_ProductDetails");

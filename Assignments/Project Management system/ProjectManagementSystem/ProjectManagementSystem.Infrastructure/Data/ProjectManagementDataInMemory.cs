...
namespace ProjectManagementSystem.Infrastructure.Data
{
    public static class ProjectManagementDataInMemory
    {
        ...
        public static List<Project> projects = new()
        {
            ...
            new Project{ProjectID = 1007,ProjectName="2022 Q4 Portfolio Analysis",DepartmentId=2, MaxHours = 800, StartDate = new DateOnly(2022,10,1), EndDate = new DateOnly(2022,1,1) },
        ...
        {
            new () {EmployeeNumber=111,EmployeeName="Rahul Kumar",FirstName="Rahul",LastName="Kumar",DepartmentId=1,Phone=123456789,Email="test@gmail.com",Salary=10000},
            new () {EmployeeNumber=112,EmployeeName="Sunil Kumar",FirstName="Sunil",LastName="Kumar",DepartmentId=1,Phone=223456789,Email="test@gmail.com",Salary=15000},
            new () {EmployeeNumber=113,EmployeeName="Mani Bupal",FirstName="Mani",LastName="Bupal",DepartmentId=1,Phone=323456789,Email="test2@gmail.com",Salary=20000},
            new () {EmployeeNumber=114,EmployeeName="Ravi Krishna",FirstName="Ravi",LastName="Krishna",DepartmentId=1,Phone=423456789,Email="test3@gmail.com",Salary=15000},
            new () {EmployeeNumber=115,EmployeeName="Sirish Karri",FirstName="Sirish",LastName="Karri",DepartmentId=2,Phone=823456789,Email="test4@gmail.com",Salary=10000},
        ...
        {
            new Assignment{ProjectId=1000,EmployeeNumber=111,HoursWorked=50,AssignmentName="Reports"},
            new Assignment{ProjectId=1000,EmployeeNumber=112,HoursWorked=100,AssignmentName="Case Study"},
            new Assignment{ProjectId=1000,EmployeeNumber=113,HoursWorked=50,AssignmentName="FileSystem"},
            new Assignment{ProjectId=1001,EmployeeNumber=114,HoursWorked=150,AssignmentName="Linq"},
            new Assignment{ProjectId=1001,EmployeeNumber=112,HoursWorked=100,AssignmentName="Case Study"},
            new Assignment{ProjectId=1001,EmployeeNumber=111,HoursWorked=140,AssignmentName="Reports"},
            new Assignment{ProjectId=1002,EmployeeNumber=113,HoursWorked=95,AssignmentName="FileSystem"},
            new Assignment{ProjectId=1002,EmployeeNumber=112,HoursWorked=85,AssignmentName="Case Study"},
            new Assignment{ProjectId=1002,EmployeeNumber=111,HoursWorked=78,AssignmentName="Reports"},
            new Assignment{ProjectId=1003,EmployeeNumber=112,HoursWorked=250,AssignmentName="Case Study"},
            new Assignment{ProjectId=1003,EmployeeNumber=114,HoursWorked=125,AssignmentName="Linq"},
            new Assignment{ProjectId=1003,EmployeeNumber=111,HoursWorked=150,AssignmentName="Reports"},
            new Assignment{ProjectId=1004,EmployeeNumber=115,HoursWorked=80,AssignmentName="Collections"},
            new Assignment{ProjectId=1004,EmployeeNumber=116,HoursWorked=70,AssignmentName="ASP"},
            new Assignment{ProjectId=1004,EmployeeNumber=117,HoursWorked=90,AssignmentName="Directory"},
            new Assignment{ProjectId=1004,EmployeeNumber=118,HoursWorked=90,AssignmentName="Testing"},
            new Assignment{ProjectId=1005,EmployeeNumber=115,HoursWorked=50,AssignmentName="Collections"},
            new Assignment{ProjectId=1005,EmployeeNumber=116,HoursWorked=300,AssignmentName="ASP"},
            new Assignment{ProjectId=1005,EmployeeNumber=117,HoursWorked=100,AssignmentName="Directory"},
            new Assignment{ProjectId=1005,EmployeeNumber=115,HoursWorked=140,AssignmentName="Collections"},
            new Assignment{ProjectId=1006,EmployeeNumber=116,HoursWorked=85,AssignmentName="ASP"},
            new Assignment{ProjectId=1006,EmployeeNumber=118,HoursWorked=95,AssignmentName="Testing"},
            new Assignment{ProjectId=1006,EmployeeNumber=117,HoursWorked=78,AssignmentName="Directory"},
            new Assignment{ProjectId=1006,EmployeeNumber=116,HoursWorked=250,AssignmentName="ASP"},
            new Assignment{ProjectId=1007,EmployeeNumber=119,HoursWorked=125,AssignmentName="Typing"},
            new Assignment{ProjectId=1007,EmployeeNumber=120,HoursWorked=150,AssignmentName="Network"},
            new Assignment{ProjectId=1007,EmployeeNumber=121,HoursWorked=80,AssignmentName="Design"},
            new Assignment{ProjectId=1007,EmployeeNumber=122,HoursWorked=140,AssignmentName="Database"},
            new Assignment{ProjectId=1008,EmployeeNumber=119,HoursWorked=85,AssignmentName="Typing"},
            new Assignment{ProjectId=1008,EmployeeNumber=120,HoursWorked=95,AssignmentName="Network"},
            new Assignment{ProjectId=1008,EmployeeNumber=121,HoursWorked=78,AssignmentName="Design"},
            new Assignment{ProjectId=1009,EmployeeNumber=119,HoursWorked=250,AssignmentName="Typing"},
            new Assignment{ProjectId=1009,EmployeeNumber=120,HoursWorked=125,AssignmentName="Network"},
            new Assignment{ProjectId=1009,EmployeeNumber=121,HoursWorked=150,AssignmentName="Design"},
            new Assignment{ProjectId=1010,EmployeeNumber=119,HoursWorked=80,AssignmentName="Typing"},
            new Assignment{ProjectId=1010,EmployeeNumber=120,HoursWorked=60,AssignmentName="Network"},
            new Assignment{ProjectId=1011,EmployeeNumber=121,HoursWorked=80,AssignmentName="Design"},
        };
    }
}
